            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class=" text-center">
                        <h1 class="hero-title mb-4">تميز - منصة تعليمية للتعليم المفتوح</h1>
                        <p class="hero-subtitle  mb-4">
                           تصفح افضل الدروس علي منصتنا مع افضل المدربين في الوطن العربي بأفضل الطرق
                        </p>
                        <a href="{{route('categories')}}" class="btn btn-theme-primary btn-lg">تصفح المواد</a>
                    </div>
<div class="text-center">
